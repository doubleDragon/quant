...
from common.depth import Item
from common.depth import Depth
...
class Bittrex(object):
    ...
    def depth(self, symbol):
        ...
        if resp is not None and u'result' in resp:
            resp = resp[u'result']
            data = {
                u'bids': [],
                u'asks': []
